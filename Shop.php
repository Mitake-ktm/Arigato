...
<html lang="fr">
  <head>
    ...
    <script
      src="https://kit.fontawesome.com/5ee2b4f395.js"
      crossorigin="anonymous"></script>
  </head>
  <body>
    <header id="headerroute">
      <div class="titre">
        <p><b>shinkei_suijaku</b></p>
        <form method="post" action="traitement.php">
          <nav>
            <ul>
              ...
              <li>
                <a style="text-decoration: none" href="memory.html"
                  ><b>JEU</b></a
                >
              </li>
              <li>
                <a style="text-decoration: none" href="scores.html"
                  ><b>SCORES</b></a
                >
              </li>
              <li>
                <a style="text-decoration: none" href="contact.html"
                  ><b>NOUS CONTACTER</b></a
                >
              </li>
            </ul>
          </nav>
