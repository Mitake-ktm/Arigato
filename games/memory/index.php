...
<body>
    ...
    <div class="haut_page_jeu">
        <div class="titre_page_de_jeu">
            <p>
            <h1> A toi de Jouer ! Bonne Chance !</h1>
        </div>
    </div>


    <div class="choisir_la_difficulte_et_le_theme">
        <form method="post" id="filter" class="">
    ...
    <div class="tableau_kana">
        <div class="kana_tableau">
            <p>Tableau Hiragana</p>
            <img src="../../assets/images/hiragana_Tableau.jpeg" alt="Hiragana Tableau">
        </div>
        <div class="kana_tableau">
            <p>Tableau Katakana</p>
            <img src="../../assets/images/Katakana_Tableau.jpeg" alt="Katakana Tableau">
        </div>
    </div>
